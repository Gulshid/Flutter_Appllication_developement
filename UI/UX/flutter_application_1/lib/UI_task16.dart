              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      SizedBox(width: 20,),
                    Text("Collection",style: TextStyle(color: Colors.black,fontSize: 23,
                    fontWeight: FontWeight.bold),)
                  ],),
                  ...
                  SizedBox(width: 20,),
                      ...
                      child: Image.asset('assets/img_15.png',fit: BoxFit.cover,),
                      ),
                      ...
                      child: Image.asset('assets/img_16.png',fit: BoxFit.cover,),
                      ),
                  ...
                  Row(children: [
                    SizedBox(width: 20,),
                    Text('Tags',style:TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),),
                  ],),
                  SizedBox(height: 10,),
                  Row(children: [
                    SizedBox(width: 20,),
                    ...
                    child: Center(
                      child: Text('Kurtas',style: TextStyle(color: Colors.black,
                      fontSize: 15,
                      fontWeight: FontWeight.bold,
                      ),),
                    ),
                   ...
                   decoration: BoxDecoration(
                    ...
                    child:  Center(
                      child: Text('Lehanga',style: TextStyle(color: Colors.black,
                      fontSize: 15,
                       fontWeight: FontWeight.bold,
                      ),),
                    ),
                  ...
                  Row(children: [
                    ...
                    child:  Center(
                      child: Text('Salwar Suit',style: TextStyle(color: Colors.black,
                      fontSize: 15,
                       fontWeight: FontWeight.bold,
                      ),),
                    ),
                    ...
                    child:  Center(
                      child: Text('Gowp',style: TextStyle(color: Colors.black,
                      fontSize: 15,
                       fontWeight: FontWeight.bold,
                      ),),
                    ),
